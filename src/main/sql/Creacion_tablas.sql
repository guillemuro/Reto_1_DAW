...
CREATE TABLE ORDER_USER (
    ...
    CONSTRAINT FK_ORDER_USER_PRODUCT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT(PRODUCT_ID),
    CONSTRAINT PK_ORDER_USER PRIMARY KEY (ORDER_NUMBER)
);
...
CREATE TABLE ORDER_DETAILS (
    ...
    PRODUCT_ID NUMBER(5),
    DATE_ADDED DATE,
    CONSTRAINT FK_ORDER_DETAILS_COFFEE_USER FOREIGN KEY (COFFEE_USER_ID) REFERENCES COFFEE_USER(COFFEE_USER_ID),

window.onload = function () {
    // Petición para obtener los cafés de la base de datos y mostrarlos en el menú
    fetch('http://localhost:8081/src/Controller?ACTION=PRODUCT.FIND&TYPE=1')
                ...
                json.forEach(element => {
                    ...
                    div.innerHTML = `
                            ...
                            <div class="informacion_producto_vendido">
                                ...
                                <div class="informacion_producto_vendido_flex">
                                    ...
                                    <a class="enlace_producto" href="../otros/Nutritional_tables_CtrlAlt_Coffee.pdf" title="Nutritional tables" target="blank">
                                        <p class="botones_info">Nutritional tables</p>
                                    </a>
                                </div>
                            </div>
                        ...
                        <button class="boton_carrito" onclick="addProduct(${element.productId})">
                            <svg viewBox="0 0 16 16" class="carrito_boton" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    // Petición para obtener el merchandising de la base de datos y mostrarlo
    fetch('http://localhost:8081/src/Controller?ACTION=PRODUCT.FIND&TYPE=6')
        .then(function (response) {
            response.json().then(function (json) {
                let cuerpoMenu = document.getElementById("merchan");
                cuerpoMenu.innerHTML = "";
                json.forEach(element => {
                    let div = document.createElement('div');
                    div.innerHTML = `

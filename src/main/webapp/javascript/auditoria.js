/*TRAE DE NUEVO LOS PRODUCTOS DE LOS TE*/
window.onload = function () {
    ...
    /*TRAE DE NUEVO LOS PRODUCTOS DE LOS ZUMOS*/
    fetch('http://localhost:8081/src/Controller?ACTION=PRODUCT.FIND&TYPE=3').then(function (response) {
        response.json().then(function (json) {
            let cuerpoMenu = document.getElementById("zumo")
            cuerpoMenu.innerHTML = ""
            json.forEach(element => {
                let div = document.createElement('div')
                div.innerHTML = `
    ...
    /*TRAE DE NUEVO LOS PRODUCTOS DE LOS DULCES*/
    fetch('http://localhost:8081/src/Controller?ACTION=PRODUCT.FIND&TYPE=4').then(function (response) {
        response.json().then(function (json) {
            let cuerpoMenu = document.getElementById("dulces")
            cuerpoMenu.innerHTML = ""
            json.forEach(element => {
                let div = document.createElement('div')
                div.innerHTML = `
    ...
    /*TRAE DE NUEVO LOS PRODUCTOS DE LOS ZUMOS*/
    fetch('http://localhost:8081/src/Controller?ACTION=PRODUCT.FIND&TYPE=5').then(function (response) {
        response.json().then(function (json) {
            let cuerpoMenu = document.getElementById("salado")
            cuerpoMenu.innerHTML = ""
            json.forEach(element => {
                let div = document.createElement('div')
                div.innerHTML = `
